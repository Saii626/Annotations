...
public @interface ScanInterface {
	...
	/**
	 * If interfaces annotated with the annotation will be managed by DIManager or not.
	 * If false, DIManager only keeps tracks of classes that implement this interface. If true, DIManager will 
